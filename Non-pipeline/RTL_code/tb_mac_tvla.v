...
// Description: Testbench TVLA (Tối ưu cho MAC KHÔNG PIPELINE - Cân bằng 1000:1000)
//////////////////////////////////////////////////////////////////////////////////
...
module tb_mac_tvla();
    ...
    // GỌI MODULE MAC ENGINE (Bên trong đã chứa mac_core_single_cycle)
    mac_engine u_mac (
        .clk(clk),
        .rst_n(rst_n),
        .start(start),
    ...
    // KHỞI TẠO CỐ ĐỊNH TẬP DỮ LIỆU ĐỂ SO SÁNH ĐỒNG NHẤT
    initial begin
    ...
    initial begin
        ...
        // Dump toàn bộ tín hiệu con sâu bên trong u_mac
        ...
        for (i = 0; i < NUM_TRACES; i = i + 1) begin
            ...
            if (count_fixed == (NUM_TRACES / 2)) begin
                ...
                is_random = {$random} % 2; // Chuẩn Verilog thay vì SV
            end
            ...
            // ---> ĐIỂM BỔ SUNG CỰC KỲ QUAN TRỌNG CHO KHỐI KHÔNG PIPELINE <---
            // Xả dữ liệu về 0 để dập tắt toàn bộ hoạt động chuyển mạch của tổ hợp
            w_in = 0;
            x_in = 0;
